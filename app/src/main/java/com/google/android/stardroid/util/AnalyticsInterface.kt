...
interface AnalyticsInterface {
    ...
    companion object {
        ...
        const val DEVICE_SENSORS = "device_sensors_prop" // Alphabetically ordered list of relevant sensors
        ...
        // Phone claims to have a sensor, but then doesn't allow registration of a
        // listener.
        ...
        const val MENU_ITEM_EVENT_VALUE = "menu_item_value"
        ...
        const val TOGGLED_NIGHT_MODE_LABEL = "toggled_night_mode"
        ...
        const val START_EVENT = "start_ev"
        const val START_EVENT_HOUR = "start_hour"
    }
}

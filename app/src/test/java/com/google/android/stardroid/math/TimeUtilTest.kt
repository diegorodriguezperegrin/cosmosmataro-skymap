...
class TimeUtilTest {
    ...
    fun testJulianDate2000AD() {
        ...
        assertThat(julianDay(year2000.timeInMillis)).isWithin(TOL)
            .of(2451544.5)
    }
    ...
    fun testJulianDate() {
        ...
        assertThat(julianDay(testCal.timeInMillis)).isWithin(TOL).of(2454833.0)

        // Jul 4, 2009, 12:00 UT1
        testCal[2009, GregorianCalendar.JULY, 4, 12, 0] = 0
        assertThat(julianDay(testCal.timeInMillis)).isWithin(TOL).of(2455017.0)

        // Sep 20, 2009, 12:00 UT1
        testCal[2009, GregorianCalendar.SEPTEMBER, 20, 12, 0] = 0
        assertThat(julianDay(testCal.timeInMillis)).isWithin(TOL).of(2455095.0)

        // Dec 25, 2010, 12:00 UT1
        testCal[2010, GregorianCalendar.DECEMBER, 25, 12, 0] = 0
        assertThat(julianDay(testCal.timeInMillis)).isWithin(TOL).of(2455556.0)
    }
    ...
    fun testJulianCenturies() {
        ...
        // Jan 1, 2009, 12:00 UT1 
        testCal[2009, GregorianCalendar.JANUARY, 1, 12, 0] = 0
        assertThat(julianCenturies(testCal.timeInMillis)).isWithin(TOL).of(0.09002)

        // Jul 4, 2009, 12:00 UT1
        testCal[2009, GregorianCalendar.JULY, 4, 12, 0] = 0
        assertThat(julianCenturies(testCal.timeInMillis)).isWithin(TOL).of(0.09506)

        // Sep 20, 2009, 12:00 UT1
        testCal[2009, GregorianCalendar.SEPTEMBER, 20, 12, 0] = 0
        assertThat(julianCenturies(testCal.timeInMillis)).isWithin(TOL).of(0.09719)

        // Dec 25, 2010, 12:00 UT1
        testCal[2010, GregorianCalendar.DECEMBER, 25, 12, 0] = 0
        assertThat(julianCenturies(testCal.timeInMillis)).isWithin(TOL).of(0.10982)
    }
    ...
    fun testMeanSiderealTime() {
        ...
        // Jan  1, 2009, 12:00 UT1
        testCal[2009, GregorianCalendar.JANUARY, 1, 12, 0] = 0
        assertThat(meanSiderealTime(testCal.timeInMillis, pit)).isWithin(LMST_TOL)
            .of(13.42f * HOURS_TO_DEGREES)
        assertThat(meanSiderealTime(testCal.timeInMillis, lon)).isWithin(LMST_TOL)
            .of(18.74f * HOURS_TO_DEGREES)
        assertThat(meanSiderealTime(testCal.timeInMillis, tok)).isWithin(LMST_TOL)
